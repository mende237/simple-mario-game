...
public class StateCompatibility {
    ...
    private static final Map<MarioState, Set<MarioState>> INCOMPATIBLE_STATES = Map.ofEntries(
            ...
            Map.entry(MarioState.STANDING, Set.of(
                    MarioState.WALKING, MarioState.JUMPING, MarioState.FALLING, MarioState.MOVING_BACKWARD,
                    MarioState.MOVING_FORWARD)),
            Map.entry(MarioState.WALKING, Set.of(
                    MarioState.STANDING, MarioState.JUMPING, MarioState.FALLING, MarioState.MOVING_BACKWARD,
                    MarioState.MOVING_FORWARD)),
            ...
            // Death/win states are terminal
            Map.entry(MarioState.DEAD, Set.of(
                    MarioState.STANDING, MarioState.WALKING, MarioState.JUMPING, MarioState.FALLING,
                    MarioState.ON_OBJECT, MarioState.HIT_COIN, MarioState.KILLING_ANTAGONIST,
                    MarioState.ZOMBIFIYING_ANTAGONIST, MarioState.HIT_BY_ANTAGONIST)),
            Map.entry(MarioState.WIN, Set.of(
                    MarioState.STANDING, MarioState.WALKING, MarioState.JUMPING, MarioState.FALLING,
                    MarioState.DEAD, MarioState.HIT_BY_ANTAGONIST)));
